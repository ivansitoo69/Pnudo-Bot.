...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ 𝘽𝙞𝙚𝙣𝙫𝙚𝙣𝙞𝙙𝙤/𝙖* \n*║*\n*╟❧ 𝘿𝙚𝙨𝙘𝙧𝙞𝙥𝙘𝙞𝙤𝙣 𝙙𝙚𝙡 𝙂𝙧𝙪𝙥𝙤:*\n\n@desc\n\n*║*\n*╟❧ 𝘿𝙞𝙫𝙞𝙚𝙧𝙩𝙚𝙩𝙚!!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ 𝙀𝙨𝙥𝙚𝙧𝙤 𝙮 𝙣𝙤 𝙫𝙪𝙚𝙡𝙫𝙖𝙨 👋🏻* \n*╚══════════════*'
conn.spromote = '*@user 𝘼𝙝𝙤𝙧𝙖 𝙀𝙨 𝘼𝙙𝙢𝙞𝙣*'
conn.sdemote = '*@user 𝙇𝙚 𝙦𝙪𝙞𝙩𝙖𝙧𝙤𝙣 𝘼𝙙𝙢𝙞𝙣*'
conn.sDesc = '*𝙎𝙚 𝙈𝙤𝙙𝙞𝙛𝙞𝙘𝙤 𝙇𝙖 𝘿𝙚𝙨𝙘𝙧𝙞𝙥𝙘𝙞𝙤𝙣*\n\n*𝘿𝙚𝙨𝙘𝙧𝙞𝙥𝙘𝙞𝙤𝙣:* @desc'
conn.sSubject = '*𝙎𝙚 𝙈𝙤𝙙𝙞𝙛𝙞𝙘𝙤 𝙇𝙖 𝙉𝙤𝙢𝙗𝙧𝙚*\n*𝙉𝙤𝙢𝙗𝙧𝙚:* @subject'
conn.sIcon = '*𝙎𝙚 𝙈𝙤𝙙𝙞𝙛𝙞𝙘𝙤 𝙇𝙖 𝙁𝙤𝙩𝙤*'
conn.sRevoke = '*𝙎𝙚 𝘼𝙘𝙩𝙪𝙖𝙡𝙞𝙯𝙤 𝙀𝙡 𝙇𝙞𝙣𝙠*\n*𝙇𝙞𝙣𝙠:* @revoke'
...
let bio = `🤖 𝙏𝙞𝙚𝙢𝙥𝙤 𝙖𝙘𝙩𝙞𝙫𝙤: ${uptime} ┃ 👑 𝘽𝙮 𝘾𝙖𝙧𝙧𝙞𝙡𝙡𝙤 ┃ 🔗 ᴄᴜᴇɴᴛᴀs ᴏғᴄ: https://www.atom.bio/theshadowbrokers-team`
